...
class shogiBeyaGraph extends HTMLElement{
    ...
    connectedCallback(){
        this.$本体 = document.querySelector(`shogi-beya[graph="${this.id}"]`)
...
customElements.define('shogi-beya-graph', shogiBeyaGraph)
customElements.define('shogi-beya', shogiBeya)
