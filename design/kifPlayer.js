...
function viewControl() {
    ...
    $('ul').append('<li class="btn1 " onclick="first()">最初へ</li>');
    $('ul').append('<li class="btn2" onclick="prev()">戻る</li>');
    $('ul').append('<li class="btn3" onclick="next()">次へ</li>');
    $('ul').append('<li class="btn4" onclick="last()">最後へ</li>');
    $('ul').append('<li class="btn5" onclick="reverse()"><span>反転</span></li>');
    $('ul').wrap('<div class="control-area" />');
}
